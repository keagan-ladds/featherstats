...
>(({ className, ...props }, ref) => (
  <ol
    ref={ref}
    className={cn(
      "ui:flex ui:flex-wrap ui:items-center ui:gap-1.5 ui:break-words ui:text-sm ui:text-muted-foreground ui:sm:gap-2.5",
      className
    )}
    {...props}
  />
...
const BreadcrumbSeparator = ({
  ...
  <li
    role="presentation"
    aria-hidden="true"
    className={cn("ui:[&>svg]:w-3.5 ui:[&>svg]:h-3.5", className)}
    {...props}
  >
