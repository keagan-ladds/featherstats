...
export default function OsSessionDurationChart({ data, loading }: Props) {
    ...
    const chartData = React.useMemo(() => {
        return getTopNWithOtherAvg(data, "avg_session_sec", "os")
    }, [data])

    return <>
        <Card className="flex flex-col">
            <CardHeader className="items-center !pb-0">
                <CardTitle>Session Duration By OS</CardTitle>
            </CardHeader>
            <CardContent className="flex-1 !p-0">
                ...
                >
                    ...
                    >
                        <ChartTooltip
                            cursor={false}
                            content={<ChartTooltipContent  nameKey="os" />}
                        />
